...
3. Overlay JS stops the current TTS source. Queued TTS stays and plays next. The Wails **Interrupt speech** button publishes the same event without enabling the HTTP API.
