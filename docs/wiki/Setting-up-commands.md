...
On **Commands**, **Play random** sends one command that has a file. Open a row menu and click **Play** to send one specific clip. Neither needs a chat line. The overlay Browser Source must be open (Home shows **Listening**).
