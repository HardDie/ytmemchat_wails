...
Do not use `http://127.0.0.1:8080/` as an OBS source. Chat query parameters are on [Chat URL](https://github.com/HardDie/ytmemchat_wails/wiki/Chat-URL).

Alerts and TTS are off until you enable them. See [Setting up commands](https://github.com/HardDie/ytmemchat_wails/wiki/Setting-up-commands), [Text to speech](https://github.com/HardDie/ytmemchat_wails/wiki/Text-to-speech), [Configuration](https://github.com/HardDie/ytmemchat_wails/wiki/Configuration), [Commands](https://github.com/HardDie/ytmemchat_wails/wiki/Commands), and [YouTube API key](https://github.com/HardDie/ytmemchat_wails/wiki/YouTube-API-key).
